  ...
  fetchRestaurantFromURL((error, restaurant) => {
    if (error) { // Got an error!
      ...
      L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token=pk.eyJ1Ijoia2FyZW5vayIsImEiOiJjam90Mzc2Z3EwNHlzM3BveDFpb29mcjlvIn0.20ILAtYbvulSdW2N_pyz8A', {
        mapboxToken: 'pk.eyJ1Ijoia2FyZW5vayIsImEiOiJjam90Mnh1N2YwdThvM3dsazV3d3VtajB6In0.t3BTo5Er4lB0ODFSxtNnzA',
        maxZoom: 18,
...
fillRestaurantHTML = (restaurant = self.restaurant) => {
  ...
  const pictureEl = document.getElementById('restaurant-img');
